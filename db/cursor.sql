...
BEGIN;
DECLARE
cursor_revers scroll cursor for
select * from products;

move last from cursor_revers; -- переход на последнюю строку
fetch prior from cursor_revers; -- результат на скриншоте 1

move backward 4 from cursor_revers; переход на 15 строку
fetch next from cursor_revers; -- результат на скриншоте 2

move backward 9 from cursor_revers; -- переход на 7 строку
fetch 1 from cursor_revers; -- результат на скриншоте 3
